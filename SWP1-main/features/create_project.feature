Feature: create project
  ...
  Scenario: A project is created with the name "Test project" successfully
   ...
   Scenario: Find a project with the name  "UI til DTU"
    ...
    Scenario: Check if employee is project leader
      Given that a project with the name "Test proj" exists
      When an employee "Martin" is assigned to the project "Test proj" as a project leader
