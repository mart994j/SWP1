...
public class Project {
	...
	public Employee projectLeaderCheck(Employee emp) throws NotProjectLeaderException {
		if (this.projectLeader == null || emp == null
                || !this.projectLeader.getInitials().equals(emp)){
